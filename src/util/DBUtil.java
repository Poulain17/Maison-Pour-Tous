...
public class DBUtil {
    ...
    public static ResultSet dbExecuteQuery(String queryStmt) throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        try {
            ...
            System.out.println("Erreur #1004 : Problème rencontré lors de l'execution de l'operation 'ExecuteQuery' : " + e);
            throw e;
        } finally {
            if (resultSet != null) {
                //Close resultSet
    ...
    public static void dbExecuteUpdate(String sqlStmt) throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        try {
            ...
            System.out.println("Erreur #1005 : Problème rencontré lors de l'execution de l'operation 'ExecuteUpdate' :  " + e);
            throw e;
        } finally {
            if (stmt != null) {
                //Close statement
